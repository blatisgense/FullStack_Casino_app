<div class="block">
    ...
    <ul class="ul">
        ...
        <li>
            ...
            <ul>
                <li><a href="#" class="li2">About technology stack</a></li>
                <li>
                ...
                <li><a href="#" class="li2">Running</a></li>
            </ul>
        </li>
        <li>
    ...
    <section id="backend">
        ...
        <div id="backend_about">
            ...
            <p class="p2">This is back-end of <b><i>Magic wheel</i></b>. Its technology stack: a database is <a class="link">PostgresQL
                </a>, as a back-end I choose <a class="link">NestJS</a> (framework for <a class="link">NodeJS</a>) + <a class="link">Express</a>.</p>
            <p class="p2"><a class="link">PostgresQL</a> because it has flexible access to data, its organization and storage. It supports: a lot of types for data values, data formats (XML, JSON, run as NoSQL, etc.), support V8 JS engine, correspond ACID, has a good npm packages: pg, pg-hstore, good UI PgAdmin. And it OpenSource and cross-platform.</p>
            <p class="p2"><a class="link">NestJS</a> is my chose for Javascript (Typescript) back-end</p>
        </div>
        <div id="backend_setup"></div>
        <div id="backend_about_code"></div>
        <div id="backend_running"></div>
    </section>
</div>
